...
CREATE TABLE `pm0_loginregister` (
  ...
  `pm0_loginregister_platform` varchar(25) NOT NULL,
...
--
-- Table structure for table `pm1_user`
--

CREATE TABLE `pm1_user` (
  ...
  `pm1_user_detailaddress` text NOT NULL,
  `pm1_user_province` char(2) NOT NULL,
  `pm1_user_regency` char(4) NOT NULL,
  `pm1_user_district` char(7) NOT NULL,
  `pm1_user_poscode` varchar(5) NOT NULL,
  `pm1_user_university` int(3) NOT NULL,
  `pm1_user_major` int(3) NOT NULL,
  `pm1_user_degree` int(1) NOT NULL,
...
--
-- Table structure for table `pm2_districts`
--

CREATE TABLE `pm2_districts` (
...
--
-- Dumping data for table `pm2_districts`
--

INSERT INTO `pm2_districts` (`id`, `regency_id`, `name`) VALUES
...
--
-- Table structure for table `pm2_provinces`
--

CREATE TABLE `pm2_provinces` (
  `id` char(2) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `pm2_provinces`
--

INSERT INTO `pm2_provinces` (`id`, `name`) VALUES
('11', 'ACEH'),
('12', 'SUMATERA UTARA'),
('13', 'SUMATERA BARAT'),
('14', 'RIAU'),
...
--
-- Table structure for table `pm2_regencies`
--

CREATE TABLE `pm2_regencies` (
...
--
-- Dumping data for table `pm2_regencies`
--

INSERT INTO `pm2_regencies` (`id`, `province_id`, `name`) VALUES
...
--
-- Table structure for table `pm3_major`
--

CREATE TABLE `pm3_major` (
  `pm3_major_id` int(11) NOT NULL,
  `pm3_major_name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pm3_major`
--

INSERT INTO `pm3_major` (`pm3_major_id`, `pm3_major_name`) VALUES
(2, 'Matematika'),
(3, 'Fisika'),
(4, 'Kimia'),
(5, 'Biologi'),
...
CREATE TABLE `pm3_university` (
  `pm3_university_id` int(11) NOT NULL,
  `pm3_university_name` varchar(100) NOT NULL,
  `pm3_university_city` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pm3_university`
--

INSERT INTO `pm3_university` (`pm3_university_id`, `pm3_university_name`, `pm3_university_city`) VALUES
...
--
-- Table structure for table `pm3_year`
--

CREATE TABLE `pm3_year` (
  `pm3_year_id` int(11) NOT NULL,
  `pm3_year_name` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `pm3_year`
--

INSERT INTO `pm3_year` (`pm3_year_id`, `pm3_year_name`) VALUES
(1, '2014'),
(2, '2015'),
(3, '2016'),
(4, '2017'),
...
--
-- Table structure for table `pm4_orders`
--

CREATE TABLE `pm4_orders` (
  `pm4_orders_id` int(11) NOT NULL,
  `pm4_orders_document_title` varchar(50) NOT NULL,
  `pm4_orders_filename` varchar(50) NOT NULL,
  `pm4_orders_pagenumber` int(5) NOT NULL,
  `pm4_orders_sender_email` varchar(50) NOT NULL,
  `pm4_orders_receiver_name` varchar(50) NOT NULL,
  `pm4_orders_receiver_phonenumber` varchar(13) NOT NULL,
  `pm4_orders_receiver_address` text NOT NULL,
...
--
-- Table structure for table `pm4_temporders`
--

CREATE TABLE `pm4_temporders` (
  `pm4_temporders_id` int(11) NOT NULL,
  `pm4_temporders_document_title` varchar(50) NOT NULL,
  `pm4_temporders_filename` varchar(50) NOT NULL,
  `pm4_temporders_pagenumber` int(5) NOT NULL,
  `pm4_temporders_sender_email` varchar(50) NOT NULL,
  `pm4_temporders_receiver_name` varchar(50) NOT NULL,
  `pm4_temporders_receiver_phonenumber` varchar(13) NOT NULL,
  `pm4_temporders_receiver_address` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `pm1_user`
  ADD PRIMARY KEY (`pm1_user_id`),
  ADD UNIQUE KEY `pm1_user_email` (`pm1_user_email`);

--
-- Indexes for table `pm2_districts`
--
ALTER TABLE `pm2_districts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `districts_id_index` (`regency_id`);

--
-- Indexes for table `pm2_provinces`
--
ALTER TABLE `pm2_provinces`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pm2_regencies`
--
ALTER TABLE `pm2_regencies`
  ADD PRIMARY KEY (`id`),
...
--
ALTER TABLE `pm3_university`
  ADD PRIMARY KEY (`pm3_university_id`);

--
-- Indexes for table `pm3_year`
--
ALTER TABLE `pm3_year`
  ADD PRIMARY KEY (`pm3_year_id`);

--
-- Indexes for table `pm4_orders`
--
ALTER TABLE `pm4_orders`
  ADD PRIMARY KEY (`pm4_orders_id`);

--
-- Indexes for table `pm4_temporders`
--
ALTER TABLE `pm4_temporders`
  ADD PRIMARY KEY (`pm4_temporders_id`);
...
--
-- Constraints for table `pm2_districts`
--
ALTER TABLE `pm2_districts`
  ADD CONSTRAINT `districts_regency_id_foreign` FOREIGN KEY (`regency_id`) REFERENCES `pm2_regencies` (`id`);

--
-- Constraints for table `pm2_regencies`
--
ALTER TABLE `pm2_regencies`
  ADD CONSTRAINT `regencies_province_id_foreign` FOREIGN KEY (`province_id`) REFERENCES `pm2_provinces` (`id`);
COMMIT;
